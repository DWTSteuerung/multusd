...
class ClassNetwork extends ClassIniFunctions
{
	...
	function HandleChangesToRestart()
	{
		if ($this->ChangedKeys)
		{
			...
			print ("<h4>Manual system reboot might be necessary </h4>");

			$ReloadNetworkFile = $this->UpdateDirectory."/ReloadNetwork";

			touch($ReloadNetworkFile);
			chmod($ReloadNetworkFile, 0666);
