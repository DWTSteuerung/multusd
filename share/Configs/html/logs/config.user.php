...
<?php if(realpath(__FILE__)===realpath($_SERVER["SCRIPT_FILENAME"])){header($_SERVER['SERVER_PROTOCOL'].' 404 Not Found');die();}?>
{
	...
	"files": {
		...
		"multusOVPNClient_0": {
			"display" : "multusOVPNClient_0.log",
			"path"    : "\/multus\/log\/multusOVPNClient_0.log",
			"refresh" : 5,
			"max"     : 20,
			"notify"  : true,
			"format"  : {
		...
		"multusOVPNClient_1": {
			"display" : "multusOVPNClient_1.log",
			"path"    : "\/multus\/log\/multusOVPNClient_1.log",
			"refresh" : 5,
			"max"     : 20,
			"notify"  : true,
			"format"  : {
		...
		"OpenVPNCheck": {
			"display" : "OpenVPNCheck.log",
			"path"    : "\/multus\/log\/OpenVPNCheck.log",
			"refresh" : 5,
			"max"     : 20,
			"notify"  : true,
			"format"  : {
