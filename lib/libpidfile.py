...
# 2020-01-04
# Karl Keusgen
# took it from the python-pidfile 2.0 
# it is all braindead, but the python-pidfile 3.0 is not compatible to the way i used the 2.0 version
# I don't feel changing all the code i've written for this stupid version thing.. so i took 2.0 in my project
# 
